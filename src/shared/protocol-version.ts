...
// Why: adding dsb to RESUMABLE_TUI_AGENTS grows terminal.ensureAgentSession's enum.
// An older host answers the unknown member with invalid_argument, which the launch
// path does not retry, so clients probe this before taking the host-authority path.
export const AGENT_SESSION_DSB_RESUME_RUNTIME_CAPABILITY = 'agent-session.dsb-resume.v1' as const
...
export const RUNTIME_CAPABILITIES = [
  ...
  AGENT_SESSION_DSB_RESUME_RUNTIME_CAPABILITY,
